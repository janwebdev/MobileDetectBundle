...
public function registerBundles()
{
    return array(
         // ...
        new Janwebdev\MobileDetectBundle\MobileDetectBundle(),
        // ...
    );
}
```
...
mobile_detect:
    ...
    device_view_class: "Janwebdev\MobileDetectBundle\Helper\DeviceView"
    request_response_listener_class: "Janwebdev\MobileDetectBundle\EventListener\RequestResponseListener"
    twig_extension_class: "Janwebdev\MobileDetectBundle\Twig\Extension\MobileDetectExtension"
```
